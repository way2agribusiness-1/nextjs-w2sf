...
export const getOrderDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`http://127.0.0.1:4000/api/v1/order/${id}`);
...
export const getPaymentStatus = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`http://127.0.0.1:4000/api/v1/payment/status/${id}`);
...
export const getAllOrders = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get('http://127.0.0.1:4000/api/v1/admin/orders');
...
export const updateOrder = (id, order) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`http://127.0.0.1:4000/api/v1/admin/order/${id}`, order, config);
...
export const deleteOrder = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`http://127.0.0.1:4000/api/v1/admin/order/${id}`);
