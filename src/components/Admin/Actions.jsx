...
const Actions = ({ slug,id, deleteHandler, name, editRoute ,updateProductHandler}) => {
    ...
    return (
        <>
            <div className="flex justify-between items-center gap-3">
                {editRoute !== "review" && (
                    <Link to={`/admin/${editRoute}/${slug}`} className="text-blue-600 hover:bg-blue-200 p-1 rounded-full bg-blue-100">
                        <EditIcon />
                    </Link>
                )}
            ...
            >
                ...
                <DialogActions>
                    ...
                    <button onClick={() => deleteHandler(slug)} className="py-2 px-6 ml-4 rounded bg-red-600 hover:bg-red-700 text-white shadow">Delete</button>
                </DialogActions>
            </Dialog>
        </>
    );
