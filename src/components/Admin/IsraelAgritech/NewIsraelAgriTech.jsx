...
import IsraelAgriTechtable from './UpdateIsraelAgritech';
...
const IsraelForm = () => {
  ...
  return (
    <div className='  p-4 bg-gray-100 shadow-lg rounded-lg ml-1 px-5'>
      <button onClick={()=>navigate("/admin/new-japan-agritech")} className='rounded-lg bg-green-600 p-2 font-bold'>Add japan technique</button>
