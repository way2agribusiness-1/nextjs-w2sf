...
import JapanAgriTechtable from './Japanagritechtable';
...
const[snackseverity,setsnackseverity]=useState('success')
  ...
  const submitHandler = async (event) => {
    ...
    try{
      const response = await axios.post("/api/v1/japan-agritech", {
        name,
        description,
  ...
  return (
    <div className='  p-4 bg-gray-100 rounded-lg ml-1'>
     <Link to="/admin/new-israel-agritech"><button  className='rounded-lg bg-green-600 p-2 font-bold'>Add Israel technique</button></Link>
