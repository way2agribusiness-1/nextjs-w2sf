...
const UpdateProduct = () => {
  ...
  const newProductSubmitHandler = (e) => {
    ...
    dispatch(updateProduct(params.slug, formData));
  };
  ...
  }, [dispatch, productSlug, product]);

  useEffect(()=>{
    if(!productSlug && params.slug){
dispatch(getProductDetails(params.slug))
    }
  ...
  return (
    <>
      <MetaData title="Admin: Update Product | way2smartfarmer" />
      ...
      >
        <div className="flex flex-col gap-3 m-2 sm:w-1/2">
          ...
          <TextField
            ...
            variant="outlined"
            size="small"
            placeholder="Enter your unique slug"
            required
            value={slug}
          ...
          <div className="flex justify-around">
            <TextField
              ...
              multiline
              rows={1}
              placeholder="Enter your Product Priority"
              required
              variant="outlined"
              size="small"
              value={priority}
          ...
          <div className="flex justify-between gap-4">
            ...
            >
              {[].concat(...Object.values(subCategories)).map((el, i) => (
                <MenuItem value={el} key={i}>
                  {el}
                </MenuItem>
              ))}
