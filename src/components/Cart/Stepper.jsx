...
const Stepper = ({ activeStep, children }) => {
    ...
    const steps = [
        ...
        },
        {
            ...
            desc: <p className="font-medium text-sm">{user.name} <span className="text-sm font-normal"></span></p>
        },
        {
            label: "ORDER SUMMARY",
        ...
        },
        {
            ...
            desc: <p className="font-medium text-sm">Online Transaction</p>
        }
    ]
        ...
        <div className="flex flex-col gap-4">
            ...
            {steps.map((step, index) => {
                ...
                return (
                    <div key={index}>
                        {activeStep === index ? (
                            <div className="flex flex-col shadow rounded-sm" key={index}>
