...
const EmptyCompare = () => {
    return (
        <div className="flex items-center flex-col gap-2 m-6">
            ...
            <span className="text-lg">Your compare is empty!</span>
            <p className="text-xs">Add items to it now.</p>
            <Link to="/agritechproducts" className="bg-primary-blue text-sm text-white px-12 py-2 rounded-sm shadow mt-3">Compare Now</Link>
        </div>
    );
};
