...
const MyOrders = () => {
  ...
  return (
    <>
      <MetaData title="My Orders | Way2SmartFarmer" />

      {/* <MinCategory /> */}
      <main className="w-full mt-16 sm:mt-0">
        {/* <!-- row --> */}
        <div className="flex gap-3.5 mt-11 sm:mt-6 sm:mx-3 m-auto mb-7">
          {/* <!-- sidebar column  --> */}
            ...
            {loading ? (
              ...
              <div className="flex flex-col gap-3 sm:mr-4 overflow-hidden">
                ...
                <form
                  ...
                  className="flex items-center justify-between mx-1 sm:mx-0 sm:w-10/12 border rounded hover:shadow"
                >
                  <input
                    value={search}
