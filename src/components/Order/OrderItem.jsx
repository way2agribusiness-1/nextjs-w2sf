...
const OrderItem = (props) => {
    ...
    return (
        <Link to={`/order_details/${orderId}`} className="flex p-4 items-start border rounded gap-2 sm:gap-0 hover:shadow-lg">
            {/* <!-- image container --> */}
            <div className="w-full sm:w-32 h-20">
                <LazyLoadImage draggable="false" className="h-full w-full object-contain" src={image} alt={name} />
            </div>
            {/* <!-- image container --> */}
