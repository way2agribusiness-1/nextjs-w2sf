...
const ResetPassword = () => {
  ...
  return (
    <>
      <MetaData title="Password Reset |  way2smartfarmer" />
        ...
        <div class="flex sm:w-4/6 sm:mt-4 m-auto mb-7 shadow-lg">
          ...
          <div class="flex-1 overflow-hidden">
            ...
            <div class="text-center py-10 px-4 sm:px-14">
              ...
              <Link to="/register" class="font-medium text-sm text-primary-blue">New to  way2smartfarmer? Create an account</Link>
            </div>
            {/* <!-- edit info container --> */}
