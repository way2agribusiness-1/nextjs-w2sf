...
const Login = () => {
  ...
  const redirect = router.query && router.query.redirect ? router.query.redirect : 'account';
//split('=')[1]
  useEffect(() => {
    if (error) {
  ...
  }, [dispatch, error, isAuthenticated, redirect, router, enqueueSnackbar]);

  return (
    <>
      <MetaData title="Login | way2smartfarmer" />
      ...
      <main className="w-full mt-12 sm:pt-20 sm:mt-0">
        ...
        <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 shadow-lg">
          {/* <!-- sidebar column  --> */}
          <div className="loginSidebar bg-primary-blue p-10 pr-12 hidden sm:flex flex-col gap-4 w-2/5" style={{backgroundColor:'green'}}>
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <div className="text-center py-10 px-4 sm:px-14">
                ...
                <div className="flex flex-col w-full gap-4">
                  ...
                  <div className="flex flex-col gap-2.5 mt-2 mb-32">
                    <p className="text-xs text-primary-grey text-left">
                      By continuing, you agree to way2smartfarmer Terms of Use
                      and{' '}
                      <a
                        href="https://www.way2agribusiness.com/knowledge-center.html"
                    ...
                    <Link
                      ...
                      style={{backgroundColor:'red',color:'greenyellow'}}
              ...
              <Link
                href="/register"
                style={{color:'rgb(70 240 40)'}}
                className="font-medium text-sm text-primary-blue"
              >
                New to Way2SmartFarmer? Create an account
              </Link>
            </div>
            {/* <!-- edit info container --> */}
          </div>
